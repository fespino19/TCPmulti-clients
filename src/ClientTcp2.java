...
public class ClientTcp2 extends Thread {
    ...
    public ClientTcp2(String hostname, int port) {
    ...
    public void run() {
        ...
        lista = new Llista("Anonimo", numberList);
        try {
    ...
    public static void main(String[] args) {
        ClientTcp2 clientTcp = new ClientTcp2("localhost", 5558);
        clientTcp.start();
    }
}